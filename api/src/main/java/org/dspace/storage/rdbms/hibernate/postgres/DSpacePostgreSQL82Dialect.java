...
public class DSpacePostgreSQL82Dialect extends PostgreSQL82Dialect
{
    ...
    public void contributeTypes(final TypeContributions typeContributions, final ServiceRegistry serviceRegistry) {
        ...
        // register the levenshtein fuzzy search function as we use it to detect duplicate items.
        registerFunction("levenshtein_less_equal", new StandardSQLFunction("levenshtein_less_equal", StandardBasicTypes.INTEGER));
